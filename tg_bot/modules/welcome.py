        ...
        for new_mem in new_members:
            ...
            # Welcome Support
             ...
             # Make bot greet admins
                ...
                update.effective_message.reply_text("Bhaiyo or Behano!, I'm {}! Thank you for adding me to {}" 
                " and be sure to check /help in PM for more commands and tricks!".format( bot.first_name, chat_name))
